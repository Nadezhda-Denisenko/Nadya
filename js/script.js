...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function myFunction6(direction, index_all) {
        ...
        document.querySelector("div.catalog div.cards:nth-of-type(1) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 0);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(1) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 0);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(2) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 1);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(2) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 1);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(3) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 2);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(3) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 2);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(4) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 3);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(4) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 3);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(5) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 4);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(5) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 4);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(6) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 5);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(6) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 5);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(7) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 6);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(7) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 6);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(8) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 7);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(8) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 7);
        }); 

        document.querySelector("div.catalog div.cards:nth-of-type(9) div[id='nextButton']").addEventListener('click', () => {
            myFunction6('next', 8);
        });
        document.querySelector("div.catalog div.cards:nth-of-type(9) div[id='prevButton']").addEventListener('click', () => {
            myFunction6('prev', 8);
        }); 
});
